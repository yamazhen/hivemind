  ...
  if (!isLoggedIn && !isInHive) {
    return (
      <section className="hidden pt-10 pl-2 pr-6 lg:flex w-1/3 xl:w-1/4 h-full items-center justify-center xl:justify-start">
        <div className="w-[300px] bg-black rounded-md px-4 py-2 text-zinc-300">
    ...
    return (
      <section className="hidden pt-10 pl-2 pr-6 lg:flex w-1/3 xl:w-1/4 h-full items-center justify-center xl:justify-start">
        <div className="w-[300px] bg-black rounded-md px-4 py-2 text-xs font-mono flex flex-col gap-1">
